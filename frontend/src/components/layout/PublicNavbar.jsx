...
import { Bot, Sparkles, Shield, Menu, X, ArrowRight, LayoutDashboard, ShieldCheck, LogOut, Cpu, Zap, Languages } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`relative flex items-center justify-between px-4 sm:px-6 py-2.5 rounded-2xl sm:rounded-full transition-all duration-500 ${
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <button
                onClick={openLanguageModal}
                className="p-2 rounded-xl border border-slate-200 dark:border-white/10 text-xs text-brand-600 dark:text-cyan-400 font-bold"
              ...
              <button
                ...
                className="p-2 rounded-xl border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10 focus:outline-none transition-colors"
                ...
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-colors ${
                      isActive(link.path)
                        ? 'text-cyan-600 dark:text-cyan-300 bg-cyan-500/10 border border-cyan-500/30 font-bold'
