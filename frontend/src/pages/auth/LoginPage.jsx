    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-cyan-500 selection:text-black relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-12 relative z-10">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-6 flex-col justify-between p-8 rounded-3xl bg-gradient-to-b from-slate-900/80 to-slate-950/90 border border-white/10 shadow-2xl backdrop-blur-2xl space-y-8">
          ...
          <div className="lg:col-span-6 w-full max-w-md mx-auto space-y-6">
            ...
            <div className="text-center space-y-2 lg:text-left">
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white">Sign In to Your Workspace</h1>
            ...
            <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-white/10 space-y-6 shadow-2xl">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 rounded-2xl border border-white/10 hover:border-cyan-500/40 bg-white/[0.04] hover:bg-white/[0.08] text-white text-xs font-bold flex items-center justify-center gap-3 transition-all shadow-sm hover:shadow-cyan-500/10"
              >
              ...
              <div className="relative my-2">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-mono font-bold tracking-widest">
                  <span className="bg-slate-900 px-3 text-slate-500">Or use email login</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-950/80 border border-white/10 rounded-2xl text-xs sm:text-sm text-slate-100 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-mono"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full pl-10 pr-11 py-3 bg-slate-950/80 border border-white/10 rounded-2xl text-xs sm:text-sm text-slate-100 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all font-mono"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-shimmer w-full py-3.5 rounded-2xl text-xs sm:text-sm font-bold bg-gradient-to-r from-cyan-500 via-brand-600 to-indigo-600 text-white hover:from-cyan-400 hover:to-brand-500 transition-all flex items-center justify-center gap-2 shadow-xl shadow-cyan-500/20 hover:scale-[1.02] active:scale-95"
                >
                  {loading ? (
