  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="space-y-1 pb-4 border-b border-slate-200 dark:border-slate-800">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">Exports & Mobile App Downloads</h1>
      ...
      <div className="glass-panel rounded-3xl p-6 sm:p-8 border-slate-200 dark:border-slate-800 bg-gradient-to-r from-brand-950/30 via-slate-900/60 to-indigo-950/30 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-brand-600 to-indigo-600 p-0.5 shadow-xl shadow-brand-500/20 flex items-center justify-center min-w-[56px]">
              <div className="w-full h-full bg-white dark:bg-slate-950 rounded-[14px] flex items-center justify-center">
                <Smartphone className="w-7 h-7 text-brand-500 dark:text-brand-400" />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-2.5 flex flex-col justify-between">
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                Open <strong className="text-slate-800 dark:text-slate-200">http://10.142.15.17:5173</strong> in your phone's Chrome browser, tap <strong className="text-slate-800 dark:text-slate-200">⋮ (Menu)</strong> and select <strong className="text-brand-500">Install App</strong>.
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-brand-600 text-white hover:bg-brand-500 transition-all shadow-md shadow-brand-600/20"
            >
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-2.5 flex flex-col justify-between">
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                Install free <strong className="text-slate-800 dark:text-slate-200">Expo Go</strong> app on your Android/iPhone, run <strong className="text-brand-500">start_mobile.bat</strong> on PC, and scan the QR code.
              </p>
            </div>
            <div className="px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-[11px] font-mono text-center text-slate-700 dark:text-slate-300">
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-2.5 flex flex-col justify-between">
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                Double-click <strong className="text-emerald-500">build_apk.bat</strong> to compile a standalone installable <strong className="text-slate-800 dark:text-slate-200">CognitiveDocAI.apk</strong> file.
              </p>
            </div>
            <div className="px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-[11px] font-mono text-center text-slate-700 dark:text-slate-300">
      ...
      <div className="space-y-4">
        {documents.map((doc) => (
          <div
            key={doc.id}
            className="glass-panel rounded-3xl p-6 border-slate-800 flex flex-col lg:flex-row lg:items-center justify-between gap-6 hover:border-brand-500/30 transition-all"
          >
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-brand-500/10 border border-brand-500/20 flex items-center justify-center text-brand-400 font-bold uppercase text-xs font-mono min-w-[48px]">
                {doc.file_type}
              </div>
              <div className="space-y-1">
                <h3 className="text-base font-bold text-white">{doc.original_name}</h3>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-slate-900 border border-slate-700 text-slate-200 hover:bg-slate-800 hover:text-white transition-colors"
                title="Export as Text"
              >
                <File className="w-3.5 h-3.5 text-brand-400" />
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-brand-600 text-white hover:bg-brand-500 transition-colors shadow-md shadow-brand-600/20"
