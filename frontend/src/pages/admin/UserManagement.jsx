...
export default function UserManagement() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Search & Stats Bar */}
      <div className="glass-panel rounded-3xl p-4 border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-950/80 border border-white/10 rounded-2xl text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-amber-500 font-mono"
          />
        </div>
        <span className="text-xs text-amber-400 font-mono hidden sm:inline font-bold">
              ...
              <tr key={u.id} className="hover:bg-white/[0.03] transition-colors">
                ...
                <td className="py-3.5">
                  <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-semibold ${
                    ...
                    <span className={`h-1.5 w-1.5 rounded-full ${u.is_active ? 'bg-emerald-400 animate-pulse' : 'bg-rose-400'}`}></span>
                ...
                <td className="py-3.5 text-right space-x-1.5">
                  {u.email === 'kancharladhanush2003@gmail.com' ? (
                    <span className="px-3.5 py-1.5 rounded-xl text-xs font-mono font-bold text-amber-300 bg-amber-500/15 border border-amber-500/40 shadow-md shadow-amber-500/10">
                      👑 Master Admin
                    </span>
                  ) : (
                    <>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-semibold transition-all ${
                          u.role === 'admin'
                            ? 'bg-white/[0.04] hover:bg-white/[0.08] text-amber-300 border border-white/10'
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-xl text-xs font-semibold bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-300 border border-indigo-500/30 inline-flex items-center gap-1 transition-all"
