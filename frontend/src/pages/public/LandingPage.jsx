...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-cyan-500 selection:text-black relative overflow-hidden">
      ...
      <section className="relative pt-12 pb-24 sm:pt-20 sm:pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            {/* Top Pill Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-cyan-300 text-xs sm:text-sm font-semibold backdrop-blur-xl shadow-lg shadow-cyan-500/10 hover:border-cyan-400/40 transition-colors">
              ...
              <span className="text-slate-300">Local Hugging Face + FAISS</span>
            </div>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-normal">
              Transform thousands of pages of legal contracts, clinical dossiers, and financial disclosures into instant executive briefings and grounded RAG citations — running entirely on your local machine with <strong className="text-white">zero external API keys</strong> and <strong className="text-white">zero data leakage</strong>.
            </p>
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              {isAuthenticated ? (
                <>
                  <Link
                    to="/dashboard"
                    className="btn-shimmer w-full sm:w-auto flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl text-sm font-bold bg-gradient-to-r from-cyan-500 via-brand-600 to-indigo-600 text-white shadow-xl shadow-brand-500/30 hover:scale-[1.02] active:scale-95 transition-all"
                  >
                  ...
                  <Link
                    to="/chat"
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-sm font-semibold bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 text-slate-200 transition-all backdrop-blur-xl"
                  >
            ...
            <div className="pt-6 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-400 font-mono">
              <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-400" /> 100% Free Open Models</span>
              <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-400" /> MongoDB Atlas Cloud Backed</span>
              <span className="flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-400" /> GDPR & HIPAA Compliant</span>
            </div>
          </div>
            ...
            {metrics.map((m, idx) => {
              ...
              return (
                <div key={idx} className="glass-card-interactive p-5 text-center group">
                  <div className="w-10 h-10 mx-auto rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 mb-3 group-hover:scale-110 transition-transform">
                    <Icon className="w-5 h-5" />
                  </div>
                  <p className="text-3xl font-extrabold text-white tracking-tight">{m.value}</p>
                  <p className="text-xs font-semibold text-slate-300 mt-1">{m.label}</p>
                  <span className="inline-block mt-2 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold bg-white/[0.05] text-cyan-400 border border-white/10">
                    {m.change}
                  </span>
                </div>
              );
          ...
          <div className="mt-20 max-w-5xl mx-auto">
            <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-white/15 shadow-2xl relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-white/10 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono font-semibold text-slate-300 pl-2 flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-1.5 bg-slate-950/80 p-1 rounded-xl border border-white/10">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                      activeTab === 'legal' ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Legal MSA
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                      activeTab === 'clinical' ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Clinical Trial
                  </button>
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                      activeTab === 'financial' ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    Financial 10-Q
                  </button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="w-full h-[220px] bg-slate-950/90 border border-white/10 rounded-2xl p-4 text-xs sm:text-sm text-slate-300 font-mono leading-relaxed overflow-y-auto">
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-400 pt-1 font-mono">
                    ...
                    <span className="text-cyan-400 font-semibold">Latency: {demoPassages[activeTab].latency}</span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className={`w-full h-[220px] bg-gradient-to-b from-slate-950 to-slate-900/90 border border-emerald-500/30 rounded-2xl p-4 text-xs sm:text-sm text-slate-100 font-mono leading-relaxed overflow-y-auto whitespace-pre-line transition-all ${
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-400 pt-1 font-mono">
                    <span className="flex items-center gap-1"><Cpu className="w-3.5 h-3.5 text-cyan-400" /> Hybrid T5-Small / TextRank</span>
                    <span className="text-emerald-400 font-bold">100% Verifiable Citations</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 relative border-t border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-xs font-mono font-semibold uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 glass-card-interactive p-8 flex flex-col justify-between">
              ...
              <div className="mt-8 p-4 rounded-2xl bg-slate-950/80 border border-white/10 font-mono text-xs text-slate-300 flex items-center justify-between">
                <span className="text-cyan-400">Query: "What is the liability cap in Section 8?"</span>
            ...
            <div className="glass-card-interactive p-8 flex flex-col justify-between">
              ...
              <div className="mt-6 flex flex-wrap gap-1.5 font-mono text-[10px]">
                <span className="px-2 py-1 rounded bg-white/[0.05] border border-white/10 text-slate-300">.PDF</span>
                <span className="px-2 py-1 rounded bg-white/[0.05] border border-white/10 text-slate-300">.DOCX</span>
                <span className="px-2 py-1 rounded bg-white/[0.05] border border-white/10 text-slate-300">.TXT</span>
                <span className="px-2 py-1 rounded bg-white/[0.05] border border-white/10 text-slate-300">.MD</span>
              </div>
            </div>
            ...
            <div className="md:col-span-2 glass-card-interactive p-8 flex flex-col justify-between">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.05] border border-white/10 text-xs font-mono text-slate-200">
      ...
      {/* CTA Final Showcase */}
      <section className="py-20 relative border-t border-white/[0.08] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-brand-950/40 via-slate-950 to-slate-950 pointer-events-none" />
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 relative z-10">
          
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/30 text-brand-300 text-xs font-mono font-semibold uppercase">
            Deploy in Seconds
          </div>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/register"
              className="btn-shimmer px-8 py-4 rounded-2xl text-base font-bold bg-gradient-to-r from-cyan-500 via-brand-600 to-indigo-600 text-white shadow-xl shadow-cyan-500/30 hover:scale-[1.03] active:scale-95 transition-all"
            >
              Launch Your Free Account
            </Link>
            <Link
              to="/login"
              className="px-8 py-4 rounded-2xl text-base font-semibold bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-slate-200 transition-all backdrop-blur-xl"
            >
